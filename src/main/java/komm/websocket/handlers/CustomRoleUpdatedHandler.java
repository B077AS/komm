...
@Slf4j
public class CustomRoleUpdatedHandler implements WsInboundMessageHandler {

    private final Gson gson = GsonProvider.get();

    @Override
    public WsMessageType getType() {
        return WsMessageType.CUSTOM_ROLE_UPDATED;
    }
    ...
    public void handle(JsonObject payload) {
        ...
        log.debug("CUSTOM_ROLE_UPDATED: roleId={}", role.getRoleId());
    }
}