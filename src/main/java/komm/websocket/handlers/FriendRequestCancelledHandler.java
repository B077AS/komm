...
public class FriendRequestCancelledHandler implements WsInboundMessageHandler {

    @Override
    public WsMessageType getType() {
        return WsMessageType.FRIEND_REQUEST_CANCELLED;
    }
            ...
            if (home.isFriendsPanelOpen()) {
                ...
                Thread.ofVirtual().start(() -> {
                    try {
                        ...
                        boolean hasPending = received != null && !received.isEmpty();
                        Platform.runLater(() -> App.setFriendRequestPending(hasPending));
